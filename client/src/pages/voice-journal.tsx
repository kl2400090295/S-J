...
import { Calendar, Mic, Droplets, Moon, Heart, Utensils, Music, ChevronLeft, ChevronRight, Plus, TrendingUp, Save, FileText, Activity, Target } from 'lucide-react';
...
export default function VoiceJournal() {
  ...
  const saveData = () => {
    try {
      ...
      toast({
        ...
        description: "Your voice journal has been saved to your device.",
      });
    } catch (error) {
      console.error('Error saving data:', error);
      toast({
        title: "Error saving data",
        description: "There was a problem saving your journal. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  const updateWeeklyActivity = (dayIndex: number, activity: string) => {
  ...
  const getWeeklyActivity = (dayIndex: number) => {
    const weekStart = formatDate(getWeekStart(currentDate));
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 rounded-b-3xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-1">
              ...
              <TrendingUp className="w-5 h-5" data-testid="header-trending-icon" />
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-4">
                ...
                <div className="text-center">
                  <div className="text-sm text-purple-600 font-medium" data-testid="text-current-date">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 rounded-2xl p-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <input
                      ...
                      className="flex-1 h-2 bg-blue-200 rounded-lg appearance-none cursor-pointer range-slider"
                      data-testid="input-hydration"
                      style={{ '--value': `${(currentEntry.hydration / 12) * 100}%` } as any}
                    />
                    <span className="text-blue-700 font-bold min-w-[4rem]" data-testid="text-hydration-value">
                ...
                <div className="bg-indigo-50 rounded-2xl p-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <input
                      ...
                      className="flex-1 h-2 bg-indigo-200 rounded-lg appearance-none cursor-pointer range-slider"
                      data-testid="input-sleep"
                      style={{ '--value': `${(currentEntry.sleep / 12) * 100}%` } as any}
                    />
                    <span className="text-indigo-700 font-bold min-w-[3rem]" data-testid="text-sleep-value">
                ...
                <div className="bg-green-50 rounded-2xl p-4">
                  ...
                  <textarea
                    ...
                    data-testid="textarea-nutrition"
                  />
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full p-3 bg-white rounded-xl border border-purple-200 focus:border-purple-400 focus:outline-none resize-none"
                      data-testid="textarea-voice-after-singing"
                    />
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'weekly' && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-4">
                ...
                <div className="text-center">
                  <div className="text-sm text-purple-600 font-medium" data-testid="text-week-range">
              ...
              <div className="space-y-4">
                ...
                {getWeekDays().map((day, index) => (
                  <div key={index} className="bg-white rounded-2xl p-4 border border-purple-100 weekly-day">
                    <div className="flex items-center justify-between mb-3">
                      <span className="font-medium text-purple-900" data-testid={`text-day-${index}`}>
                        {day.toLocaleDateString('en-US', { weekday: 'long' })}
                      </span>
                      <span className="text-sm text-purple-600" data-testid={`text-date-${index}`}>
                    ...
                    <textarea
                      ...
                      data-testid={`textarea-activity-${index}`}
                    />
                  </div>
                ))}
              </div>
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {['Warm-ups', 'Scales', 'Performance', 'Rest Day'].map((activity) => (
                    <button
                      key={activity}
                      onClick={() => {
                        // Add to current day for demo
                        const today = new Date().getDay();
                        const currentActivity = getWeeklyActivity(today);
                        const newActivity = currentActivity ? `${currentActivity}, ${activity}` : activity;
                        updateWeeklyActivity(today, newActivity);
                      }}
                      className="p-3 bg-purple-100 rounded-xl text-purple-700 font-medium hover:bg-purple-200 transition-colors text-sm"
                      data-testid={`button-quick-${activity.toLowerCase().replace(' ', '-')}`}
                    >
                      {activity}
                    </button>
                  ))}
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-2xl font-bold text-blue-700" data-testid="text-avg-hydration">
                  ...
                  <div className="bg-indigo-50 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-2xl font-bold text-indigo-700" data-testid="text-avg-sleep">
                        {stats.avgSleep}h
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-2xl font-bold text-purple-700" data-testid="text-entries-count">
